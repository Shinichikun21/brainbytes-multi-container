...
function getDetailedResponse(category, question) {
  ...
  if (lowerQuestion === 'what is science') {
   ...
   if (lowerQuestion === 'who is the father of physics') {
    return "While there isn't one single individual universally recognized as the father of physics, Galileo Galilei is often called the father of modern physics for his pioneering work in developing the scientific method and his contributions to mechanics and astronomy. Isaac Newton is also a strong contender, especially for classical physics, due to his laws of motion and universal gravitation. Albert Einstein is considered the father of modern physics for his groundbreaking theories of relativity. ";
  }
  ...
  if (category === 'science') {
    ...
    if (lowerQuestion.includes('father of physics')) {
      return "While there isn't one single individual universally recognized as the father of physics, Galileo Galilei is often called the father of modern physics for his pioneering work in developing the scientific method and his contributions to mechanics and astronomy. Isaac Newton is also a strong contender, especially for classical physics, due to his laws of motion and universal gravitation. Albert Einstein is considered the father of modern physics for his groundbreaking theories of relativity.";
    }
